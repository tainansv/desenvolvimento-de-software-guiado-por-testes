...
public class TesteIntegracao {
	...
	public void inicializa() throws IOException{
		...
		placar = new Placar();
		placar.setArmazenamento(armazen);
	...
	public void recuperarPontosDeUmTipoDoUsuario() throws IOException {
		assertEquals(15, armazen.getPontosUsuario("pedro", "moeda"));
		assertEquals(5, armazen.getPontosUsuario("pedro", "ouro"));
	}
